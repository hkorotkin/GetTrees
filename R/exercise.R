...
#get null - where is matched_studies? 
	#changed from matched_studies to study_ids
	...
	anolis.study1.metadata <- get_study_meta(anolis.studies.ids[[1]])
	...
	anolis.study1.tree1 <- get_study_tree(study_id=anolis.studies.ids[[1]],tree_id=anolis.studies[[3]])
